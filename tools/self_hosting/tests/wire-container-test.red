...
assert (checksum rscf 'SHA256) =
	#{69C6C8F3E4E50B348526B88766178A04C054AFD9D03F1E9CB2BB09B88BC8A616}
	"RSCF golden bytes changed"
assert (checksum rsir 'SHA256) =
	#{D707B74056DE5CC6E27AAB3F164492DAA7F9A94DB1A2E991B6D0617D0A84D54D}
	"RSIR golden bytes changed"
assert (checksum rscg 'SHA256) =
	#{2F0A6DF08CFE1046EC776F87832183B2708D4B27B04EDF65B21A05355712B2BF}
	"RSCG golden bytes changed"
assert (checksum rsdg 'SHA256) =
	#{912A7AF421F8DADC18273D54CDF1F51A6EEF2F2FAD1DD82CA716212FFEA1FB35}
