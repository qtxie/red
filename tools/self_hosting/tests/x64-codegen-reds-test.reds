...
put import-ir 132 2
put import-ir 136 0
copy-memory (import-ir + 140) (as byte-ptr! "fixture.dllnative-callfn") 24

size: x64-codegen/generate import-ir 164 output 512 0
...
if size = 252 [
	...
	first-import: as codegen-import! (output + 76)
	second-import: as codegen-import! (output + 100)
	if any [
	...
	reference: as int-ptr! (output + 124)
	if reference/1 <> 26 [failures: failures + 1]
	if reference/2 <> 34 [failures: failures + 1]
	if (compare-memory (output + 132)
