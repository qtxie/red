Red [
	...
	File:    %Mach-O-ARM64.red
	License: "BSD-3 - https://github.com/red/red/blob/master/BSD-3-License.txt"
]

system-format-MachO-ARM64: context [
	defs: context [
		extensions: [
			exe %""
			obj %.o
	...
	append-u32: func [out [binary!] value [integer! char!]][
		append out int-to-bin/to-bin32 value
	]

	append-u16: func [out [binary!] value [integer! char!]][
		append out int-to-bin/to-bin16 value
	]

	append-u8: func [out [binary!] value [integer! char!]][
		append out int-to-bin/to-bin8 value
	]

	append-u64: func [out [binary!] value [integer! char! block!]][
		append out int-to-bin/to-bin64 value
	]
	...
	set-preferred-pointer-high: func [buffer [binary!] relocs [block!]][
		foreach offset relocs [change/part at buffer offset + 5 int-to-bin/to-bin32 1 4]
	]
		...
		foreach record imports [
			foreach ref record/3 [
				either block? ref [
					...
					change/part at code ref int-to-bin/to-bin32 opcode 4
				]
			]
		]
	]
