...
failures: 0
code: allocate x64-encoder/I32_ENTRY_SIZE
if null? code [quit 1]

size: x64-encoder/encode code x64-encoder/VOID_SIZE false false 0 0
if size <> x64-encoder/VOID_SIZE [failures: failures + 1]
if (compare-memory code (as byte-ptr! expected-void) size) <> 0 [
	failures: failures + 1
]

size: x64-encoder/encode code x64-encoder/VOID_ENTRY_SIZE true false 0 0
...
size: x64-encoder/encode code x64-encoder/I32_SIZE false true 7 0
if size <> x64-encoder/I32_SIZE [failures: failures + 1]
if (compare-memory code (as byte-ptr! expected-i32) size) <> 0 [
	failures: failures + 1
]

size: x64-encoder/encode code x64-encoder/I32_ENTRY_SIZE true true 7 0
...
size: x64-encoder/encode code (x64-encoder/VOID_SIZE - 1) false false 0 0
