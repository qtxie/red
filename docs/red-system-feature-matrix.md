...
| Signed and unsigned fixed-width integers | Width/sign in logical type; generic integer selection | units/fixed-int-test.reds, int64-test.reds, x64-fixed-int-*.reds | pending |
