...
wire-container-reader: context [
		...
		case [
			...
			magic = WIRE_MAGIC_RSIR [
				case [
					...
					kind = WIRE_RSIR_SECTION_CONSTANT_BINDINGS [WIRE_RSIR_SECTION_CONSTANT_BINDINGS_RECORD_SIZE]
					...
					kind = WIRE_RSIR_SECTION_SUBROUTINES [WIRE_RSIR_SECTION_SUBROUTINES_RECORD_SIZE]
					kind = WIRE_RSIR_SECTION_SUBROUTINE_BLOCKS [WIRE_RSIR_SECTION_SUBROUTINE_BLOCKS_RECORD_SIZE]
					true [-1]
				]
			]
			magic = WIRE_MAGIC_RSCG [
				case [
					...
					kind = WIRE_RSCG_SECTION_MODULES [WIRE_RSCG_SECTION_MODULES_RECORD_SIZE]
	...
	expected-cardinality: func [magic kind [integer!] return: [integer!]][
		case [
			...
			magic = WIRE_MAGIC_RSCG [
				case [
					kind = WIRE_RSCG_SECTION_DATA_LAYOUT [WIRE_SECTION_CARDINALITY_ONE]
					kind = WIRE_RSCG_SECTION_MODULES [WIRE_SECTION_CARDINALITY_NONEMPTY]
					true [WIRE_SECTION_CARDINALITY_ANY]
				]
			]
			magic = WIRE_MAGIC_RSDG [
