...
IDWriteTextLayout: alias struct! [
	...
	GetFontCollection1				[int-ptr!]
	GetFontFamilyNameLength1		[int-ptr!]
	GetFontFamilyName1				[int-ptr!]
	GetFontWeight1					[int-ptr!]
	GetFontStyle1					[int-ptr!]
	GetFontStretch1					[int-ptr!]
	GetFontSize1					[int-ptr!]
	GetUnderline					[int-ptr!]
	GetStrikethrough				[int-ptr!]
	GetDrawingEffect				[int-ptr!]
	GetInlineObject					[int-ptr!]
	GetTypography					[int-ptr!]
	GetLocaleNameLength1			[int-ptr!]
	GetLocaleName1					[int-ptr!]
	Draw							[int-ptr!]
...
set-line-spacing: func [
	...
	;-- "I" in UTF-16: a layout has to exist before its line metrics exist
