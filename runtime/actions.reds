...
;		]
	...
	op2i*: func [										;-- fused binary math op with integer RHS
		op		[integer!]
		sym		[red-word!]
		left	[red-value!]
		i2		[integer!]
	...
	cmp2*: func [										;-- fused comparison, int/int fast path
		op		[integer!]
		sym		[red-word!]
		left	[red-value!]
		right	[red-value!]
	...
	cmp2i*: func [										;-- fused comparison with integer RHS
		op		[integer!]
		sym		[red-word!]
		left	[red-value!]
		i2		[integer!]
	...
	cmp2b*: func [										;-- fused comparison conditional, no stack result
		op		[integer!]
		sym		[red-word!]
		left	[red-value!]
		right	[red-value!]
	...
	cmp2ib*: func [										;-- fused comparison conditional with integer RHS
		op		[integer!]
		sym		[red-word!]
		left	[red-value!]
		i2		[integer!]
