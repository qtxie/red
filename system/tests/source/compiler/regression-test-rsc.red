...
either (as integer! str) = (as integer! s) [print ["ok" lf]] [print ["ko" lf]]
		...
		--assert not not none? find qt/output "ko"
...
probe 1.836E13
		...
		--assert not not none? find qt/output "13.0"
...
probe [this that]
	...
	--test-- "#5653"
		...
		--assert compiled?
		--assert not crashed?
		--assert not none? find qt/output "true"
	...
	--test-- "#5650"
		...
		--assert compiled?
		--assert not not none? find qt/output "false"
