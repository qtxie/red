...
if WIRE_SCHEMA_FINGERPRINT <> 511244214 [status: 5]
...
if WIRE_ATOMIC_RMW_OPERATION_BIT_XOR <> 5 [status: 32]
if WIRE_ATOMIC_FLAG_RETURN_OLD <> 8 [status: 33]
if WIRE_ATOMIC_ERROR_BAD_RETURN_MODE <> 16 [status: 34]
